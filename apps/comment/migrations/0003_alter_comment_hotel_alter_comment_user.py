...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('hotels', '0001_initial'),
        ('comment', '0002_alter_comment_hotel_alter_comment_user'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='comment',
            name='hotel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='hotels.hotel'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='user',
